...
class DelayedTask implements Runnable, Delayed {
    ...
    public static class EndSentinel extends DelayedTask { // задача - точка останова
        private ExecutorService exec;
        public EndSentinel(int delay, ExecutorService e) { // запускальщик для того
            super(delay);
            exec = e;
        }
        ...
        public void run() {
            ...
            exec.shutdownNow();  // чтобы завершить его тут!
        }
    }
}
